export const logSession = {
  ...
  "logSession.addTimes": "+ Ajouter l’heure de début et de fin",
  "logSession.timesHint": "Facultatif. Sans heures, le carnet n’affiche aucune durée.",
  ...
  "logSession.draftMeta_one": "{count} ligne{times} · enregistrée sur cet appareil uniquement",
  "logSession.draftMeta_other": "{count} lignes{times} · enregistrées sur cet appareil uniquement",
