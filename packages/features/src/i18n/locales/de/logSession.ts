export const logSession = {
  ...
  "logSession.climbOf": "{n} von {total}",
  ...
  "logSession.addTimes": "+ Start- und Endzeit hinzufügen",
  "logSession.timesHint": "Optional. Ohne Zeiten zeigt das Logbuch keine Dauer.",
  ...
  "logSession.draftMeta_one": "{count} Kletterei{times} · nur auf diesem Gerät gespeichert",
  "logSession.draftMeta_other": "{count} Klettereien{times} · nur auf diesem Gerät gespeichert",
