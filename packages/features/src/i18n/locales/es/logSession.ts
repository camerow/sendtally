export const logSession = {
  ...
  "logSession.addTimes": "+ Añadir hora de inicio y de fin",
  "logSession.timesHint": "Opcional. Si lo dejas en blanco, el registro no muestra duración.",
  ...
  "logSession.draftMeta_one": "{count} escalada{times} · guardada solo en este dispositivo",
  "logSession.draftMeta_other": "{count} escaladas{times} · guardadas solo en este dispositivo",
