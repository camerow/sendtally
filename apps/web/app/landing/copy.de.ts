  ...
  hero: {
    features: [
      ...
      },
      {
        ...
        cardCaption: "RPE · LETZTE 8 WOCHEN",
        chartLabel: "RPE PRO SESSION",
      },
      {
        key: "pyramid",
    ...
    faces: {
      ...
      rpeLastSession: "RPE LETZTE SESSION",
      via: "via sendtally",
