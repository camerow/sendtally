...
export const COPY_FR: LandingCopy = {
  ...
  hero: {
    features: [
      ...
      },
      {
        ...
        cardTitle: "Effort",
        cardCaption: "RPE · 8 DERNIÈRES SEMAINES",
        chartLabel: "RPE PAR SÉANCE",
      },
      {
        key: "pyramid",
    ...
    faces: {
      ...
      rpeLastSession: "RPE DERNIÈRE SÉANCE",
      via: "via sendtally",
    ...
    body: "Enregistrez vos séances vite et simplement - cotations, croix, essais. Utilisez le RPE pour suivre votre effort dans le temps. Publiez sur Strava pour voir votre escalade à côté de vos autres activités. L'abonnement ajoute les tendances et l'analyse : volume, pyramide des cotations, croix la plus dure, taux de flash et cotation moyenne.",
  },
  ...
  free: {
    ...
    features: [
      ...
      {
        eyebrow: "EFFORT",
        title: "Un RPE pour chaque séance",
