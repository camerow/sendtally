  ...
  hero: {
    features: [
      ...
      },
      {
        ...
        cardTitle: "Esfuerzo",
        cardCaption: "RPE · ÚLTIMAS 8 SEMANAS",
        chartLabel: "RPE POR SESIÓN",
      },
      {
        key: "pyramid",
    ...
    faces: {
      ...
      rpeLastSession: "RPE ÚLTIMA SESIÓN",
      via: "via sendtally",
    ...
    body: "Registra tus sesiones rápido y fácil - grados, encadenes, intentos. Usa el RPE para seguir tu esfuerzo a lo largo del tiempo. Publica en Strava y ve tu escalada junto a tus otras actividades. La suscripción añade tendencias y análisis: volumen, pirámide de grados, encadene más duro, porcentaje de flash y grado medio.",
  },
